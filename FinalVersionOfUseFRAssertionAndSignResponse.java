...
public class response {
	...
	public static String ssoACS = "https://dealerqa.creditacceptance.com/c/portal/saml/acs";
	...
	public static void main(String[] args) throws UnsupportedEncodingException, XPathExpressionException, XMLSecurityException {
		...
		String FRapi = "<saml:Assertion xmlns:saml=\\\"urn:oasis:names:tc:SAML:2.0:assertion\\\" ID=\\\"s29ecec0da706f0e434713fe38b17fa529e1981b19\\\" IssueInstant=\\\"2019-05-02T14:30:16Z\\\" Version=\\\"2.0\\\">\\n<saml:Issuer>https://qaaccess.creditacceptance.com:8443/openam</saml:Issuer><ds:Signature xmlns:ds=\\\"http://www.w3.org/2000/09/xmldsig#\\\">\\n<ds:SignedInfo>\\n<ds:CanonicalizationMethod Algorithm=\\\"http://www.w3.org/2001/10/xml-exc-c14n#\\\"/>\\n<ds:SignatureMethod Algorithm=\\\"http://www.w3.org/2001/04/xmldsig-more#rsa-sha512\\\"/>\\n<ds:Reference URI=\\\"#s29ecec0da706f0e434713fe38b17fa529e1981b19\\\">\\n<ds:Transforms>\\n<ds:Transform Algorithm=\\\"http://www.w3.org/2000/09/xmldsig#enveloped-signature\\\"/>\\n<ds:Transform Algorithm=\\\"http://www.w3.org/2001/10/xml-exc-c14n#\\\"/>\\n</ds:Transforms>\\n<ds:DigestMethod Algorithm=\\\"http://www.w3.org/2001/04/xmlenc#sha512\\\"/>\\n<ds:DigestValue>hOY3hf0gL1fJeBTXs0pp99epCCPy2HDXM4M7UHg0uneVBGOTIoGQh1zUH7xAqBCGNTSt8yI7TnEs\\nzzOQfbLVAw==</ds:DigestValue>\\n</ds:Reference>\\n</ds:SignedInfo>\\n<ds:SignatureValue>\\nQkCz1k1EO+lB3Mrsg5ta+B4LoOpEpaRdcugBhTje8EtrNm0dEmyUrYKsV6ehLPZHIjGEcQ5Sa0Ao\\nTzXHY6p8ekL6p39GwEc/qrFaIH0BsuKqtrI4ABqVfCPRcdcRV/jFkse68edLVwxLkQlozjaWFQmk\\nC85EnrRpHMXRYr5hOYg=\\n</ds:SignatureValue>\\n<ds:KeyInfo>\\n<ds:X509Data>\\n<ds:X509Certificate>\\nMIICSjCCAbOgAwIBAgIEbt/YvzANBgkqhkiG9w0BAQsFADBYMQswCQYDVQQGEwJVUzELMAkGA1UE\\nCBMCTUkxEzARBgNVBAcTClNvdXRoZmllbGQxCzAJBgNVBAoTAkZSMQwwCgYDVQQLEwNDQUMxDDAK\\nBgNVBAMTA1hpbjAeFw0xODAxMTUxNjEwMDVaFw0yMDAxMTUxNjEwMDVaMFgxCzAJBgNVBAYTAlVT\\nMQswCQYDVQQIEwJNSTETMBEGA1UEBxMKU291dGhmaWVsZDELMAkGA1UEChMCRlIxDDAKBgNVBAsT\\nA0NBQzEMMAoGA1UEAxMDWGluMIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCYxD9iYWrLYaEO\\nWr8NJMRDaL4/YqsWSuonJ0rkJkxpicpjEM6ui3L01NXi3WrmdITpNOrCB1aYE0pT9U1jkO1bKIsg\\nKyBi3HPcF/lUCvxrzEWGyW/vpUF6QS5KKJYxoMAja6dCkirEct8X9DLKu5q8Q9Q4TUDPWSAEG4zh\\n8IJ+owIDAQABoyEwHzAdBgNVHQ4EFgQUwLhIL0HDjGt4w5W+3ZE1RIXIggMwDQYJKoZIhvcNAQEL\\nBQADgYEAd6/QkKLq91N5qMUy7sMZHb1NR8LM3rE3diB2p54YpdoLbPe8kpDvDbz47kf4oua1KsVI\\nBfnhb4/YPCpOVOPPzBqg2WzMhvfiWsqTqhhrPJghjK8tINbVUD+wVNwCWfftQliqucwnw6vlBCQZ\\nbbEdBQNEDFDvvWd9ougyO84hQyU=\\n</ds:X509Certificate>\\n</ds:X509Data>\\n</ds:KeyInfo>\\n</ds:Signature><saml:Subject>\\n<saml:NameID Format=\\\"urn:oasis:names:tc:SAML:1.0:nameid-format:unspecified\\\">xlian</saml:NameID><saml:SubjectConfirmation Method=\\\"urn:oasis:names:tc:SAML:2.0:cm:bearer\\\">\\n<saml:SubjectConfirmationData NotOnOrAfter=\\\"2019-05-02T14:40:16Z\\\" Recipient=\\\"https://dealerqa.creditacceptance.com/c/portal/saml/acs\\\"/></saml:SubjectConfirmation>\\n</saml:Subject><saml:Conditions NotBefore=\\\"2019-05-02T14:30:16Z\\\" NotOnOrAfter=\\\"2019-05-02T14:40:16Z\\\">\\n<saml:AudienceRestriction>\\n<saml:Audience>lrsamlsp</saml:Audience>\\n</saml:AudienceRestriction>\\n</saml:Conditions>\\n<saml:AuthnStatement AuthnInstant=\\\"2019-05-02T14:30:16Z\\\"><saml:AuthnContext><saml:AuthnContextClassRef>urn:oasis:names:tc:SAML:2.0:ac:classes:PreviousSession</saml:AuthnContextClassRef></saml:AuthnContext></saml:AuthnStatement><saml:AttributeStatement><saml:Attribute Name=\\\"AuthSource\\\"><saml:AttributeValue xmlns:xs=\\\"http://www.w3.org/2001/XMLSchema\\\" xmlns:xsi=\\\"http://www.w3.org/2001/XMLSchema-instance\\\" xsi:type=\\\"xs:string\\\">2</saml:AttributeValue></saml:Attribute><saml:Attribute Name=\\\"uid\\\"><saml:AttributeValue xmlns:xs=\\\"http://www.w3.org/2001/XMLSchema\\\" xmlns:xsi=\\\"http://www.w3.org/2001/XMLSchema-instance\\\" xsi:type=\\\"xs:string\\\">xlian</saml:AttributeValue></saml:Attribute></saml:AttributeStatement></saml:Assertion>";
		       FRapi = FRapi.replace("\\n","\n");
		...
		byte[] encodedBytes = Base64.getEncoder().encode(unsignedSAMLResponseInXML.getBytes());
		String encodedUnsignedSAMLResponse = new String(encodedBytes);
		//System.out.println(encodedUnsignedSAMLResponse);	
		String encodedSignedSAMLResponse = res.SignResponse(unsignedSAMLResponseInXML);
		System.out.println(encodedSignedSAMLResponse);
				
		//res.post(encodedUnsignedSAMLResponse);
...
//Sign SAMLResonse	
	public String SignResponse(String unsignedSamlXMLResponse) throws UnsupportedEncodingException, XPathExpressionException, XMLSecurityException{
		...
		byte[] encodedBytes = Base64.getEncoder().encode(signedSAMLResponseInXML.getBytes());
		String encodedSignedSAMLResponse = new String(encodedBytes);		
